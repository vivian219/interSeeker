...
def readAllPdf(filePath,txt_obj):
    ...
    for file in files:  # 遍历文件夹
        ...
        if not os.path.isdir(file):  # 判断是否是文件夹，不是文件夹才打开
            ...
            txt_obj.public(json.dumps({"md5":report_md5,"title":file.split('.pdf')[0],"tag":"","abstract":"","time":str(_time),"urlList":""}))
            time.sleep(3)
    #print(s)  # 打印结果
    return s
def getPdfContent(fileName):
    #print(fileName)
    fileDir="F:/PythonProjects/ElasticSearchWeb/files/2018/"
...
pdfList=readAllPdf("F:/PythonProjects/ElasticSearchWeb/files/2018/",txt_pub)
print(pdfList)
